...
class _CirillaProductItemState extends State<CirillaProductItem>
  ...
  void didChangeDependencies() {
    ...
    int min = b2bkingFilterQuantity(context, 1, widget.product ?? Product(), "min") ?? 1;
    int step = b2bkingFilterQuantity(context, 1, widget.product ?? Product(), "step") ?? 1;
          ...
          builder: (_) {
            switch (widget.template) {
                    ...
                    addCart: enableAddCart
                        ? _loading
                            ...
                            : buildAddCart(
                                ...
                                icon: widget.iconAddCart ?? FeatherIcons.truck, //sasa
                  ...
                  addCart: enableAddCart
                      ? _loading
                          ...
                          : buildAddCart(
                              ...
                              product: widget.product!,
                              onTap: () => _handleAddToCart(context),
                              icon: widget.iconAddCart ?? FeatherIcons.truck,
              ...
              case Strings.productItemCurve:
                ...
                double heightImage = (widthImage * widget.height) / widget.width;
                bool enableProgressSale = get(widget.dataTemplate, ['enableProgressSale'], false);
                  ...
                  addCart: enableAddCart
                      ? _loading
                          ...
                          : buildAddCart(
                              context,
                              product: widget.product!,
                              icon: widget.iconAddCart ?? FeatherIcons.truck, //sasa truck
                              radius: widget.radiusAddCart ?? 8,
                              isButtonOutline: widget.outlineAddCart ?? false,
                              onTap: () => _handleAddToCart(context),
