...
abstract class CheckoutStoreBase with Store {
      ...
      List<dynamic> paymentData,
  {
    ...
    Map<String, dynamic> billing = {
      ...
      ...billingAddress,
      if (billingOptions != null) ...billingOptions,
    };
    ...
    Map<String, dynamic> newAdditional = additional ?? {};
    if (newAdditional.isNotEmpty) {
      newAdditional.removeWhere((_, v) => v == null || v == "" || (v is Map && v.isEmpty) || (v is List && v.isEmpty));
    }
    ...
    try {
      ...
      Map<String, dynamic> cartData = {
        ...
        if (newAdditional.isNotEmpty) 'additional': newAdditional,
  ...
  Future<void> updateBillingFromMap({
   ...
   // billing['address_1'] = place.address;
    ...
    String mapsUrl = //sasa
        "https://www.google.com/maps?q=${deliveryLocation?.lat},${deliveryLocation?.lng}"; //sasa

    billing['address_2'] = mapsUrl ?? ''; //sasa
    billing['wooccm10'] = mapsUrl ?? ''; //sasa
    ...
    checkoutAddressStore.getAddresses([country], locale ?? defaultLanguage);
  }
  ...
  Future<void> updateShippingFromMap({
    ...
    shipping['address_2'] = mapsUrl; //sasa
    shipping['wooccm10'] = mapsUrl; //sasa




    //shipping['address_2'] = address2 ?? ''; //sasa
