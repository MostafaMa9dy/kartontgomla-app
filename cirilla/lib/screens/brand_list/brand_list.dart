...
class _ScrollAlphabet extends State<ScrollAlphabet> with AppBarMixin, TransitionMixin, LoadingMixin {
  ...
  void _onScrollMore() {
    if (!_controller.hasClients || _brandStore.loading || !_brandStore.canLoadMore) return;
      ...
      child: Stack(
        children: [
                    ...
                    child: Container(
                      ...
                      child: SizedBox(
                        ...
                        child: Search(
                          ...
                          label: Text(translate('brand_search'), style: theme.textTheme.bodyLarge),
                    ...
                    return SliverPadding(
                      ...
                      sliver: SliverStickyHeader.builder(
                        builder: (_, SliverStickyHeaderState state) {
                          Color color = theme.textTheme.titleLarge?.color ?? Colors.black;
                            ...
                            return Container(
                              ...
                              child: Text(
                                ...
                                style: theme.textTheme.titleLarge
                                    ?.copyWith(color: color.withValues(alpha:1 - state.scrollPercentage)),
                              ),
                            );
                          }
          ...
          if (brandsIsNotEmpty) ...[
                      ...
                      child: InkWell(
                        child: Text(
                          ...
                          style: theme.textTheme.labelSmall?.copyWith(
                            color: visitSelect == index ? theme.textTheme.titleLarge?.color : null,
            ...
            loading ? Center(child: buildLoading(context, isLoading: loading)) : _buildBrandEmpty(),
          ]
        ],
      ),
    );
  ...
  Widget _buildBrandEmpty() {
    ...
    return NotificationScreen(
      ...
      content: Text(translate('brand_empty'), style: Theme.of(context).textTheme.bodyMedium),
