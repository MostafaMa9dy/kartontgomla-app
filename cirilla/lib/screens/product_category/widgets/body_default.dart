...
///
class DefaultCategory extends StatelessWidget with LoadingMixin, Utility, ContainerMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Widget? banner = buildBanner(context, configs: configs, imageKey: imageKey, themeModeKey: themeModeKey);
