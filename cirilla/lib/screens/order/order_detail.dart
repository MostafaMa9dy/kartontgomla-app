...
class _OrderDetailScreenState extends State<OrderDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    Widget? actions = buildActions(context, _orderData, translate);
      ...
      builder: (_) {
        return Stack(
          children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        buildItem(
                            padding: const EdgeInsetsDirectional.only(start: itemPaddingMedium),
                            title: translate('checkout_note'),
                            subTitle: _orderData!.customerNote ?? ''),
                        Padding(
                          padding: EdgeInsetsDirectional.only(
                            start: itemPaddingMedium,
                            end: itemPaddingMedium,
                            bottom: actions == null ? itemPaddingMedium : 0,
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
            ...
            if (loadingOrderAgain) buildLoadingOrderAgain(),
          ],
        );
      },
    );
