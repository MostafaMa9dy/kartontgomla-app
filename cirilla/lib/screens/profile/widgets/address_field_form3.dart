              ...
              if (keys.isNotEmpty)
                ...List.generate(
                  ...
                  (index) {
                    ...
                    if (hiddenCheckoutFields.any((e) => key.contains(e))) {
                      type = "hidden";
                    }
                    ...
                    switch (type) {
                      case 'text':
                        child = AddressFieldText(
                          ...
                          suffixIcon: ((field['autocomplete'] ?? '').toString().contains('address-line2') && //sasa  (field['autocomplete'] == 'address-line1' &&
