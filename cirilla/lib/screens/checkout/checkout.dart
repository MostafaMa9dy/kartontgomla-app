...
List<IconData> _tabIcons = [FeatherIcons.mapPin, FeatherIcons.pocket, FeatherIcons.truck]; //sasa box => truck
                            ...
                            onPressed: () async {
                              ...
                              if (result != null) {
                                if (result['user_location'] is UserLocation) {
                                  checkoutStore.deliveryLocation = result['user_location'];
                                }
                              ...
                              // بعد ما يرجع من الخريطة يكمل طبيعي
                              onGoPage(1, 0);
                            },
                          ),
                          theme: theme,
