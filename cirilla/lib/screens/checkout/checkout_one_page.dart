              ...
              Column(
                children: [
                  Expanded(
                    ...
                    //sasa
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: layoutPadding, vertical: 8),
                    child: Observer(
                      builder: (_) {
                        final checkoutStore = _cartStore.checkoutStore;
                        final hasLocation = checkoutStore.deliveryLocation != null;
                            ...
                            onPressed: () async {
                              ...
                              if (result != null) {
                                if (result['user_location'] is UserLocation) {
                                  checkoutStore.deliveryLocation =
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          final hasLocation =
                              _cartStore.checkoutStore.deliveryLocation != null;

                          if (!hasLocation) {
                            showError(context, "من فضلك حدد موقع التوصيل أولاً");
                            return;
                          }
